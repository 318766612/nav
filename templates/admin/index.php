...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header">
        ...
        <div class="layuimini-header-content">
            <a>
                <div class="layuimini-tool"><i title="左侧栏展开/收缩" class="fa fa-outdent" style="font-size: 1.1rem;"
                                               data-side-fold="1"></i></div>
            </a>
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item" lay-unselect><a href="javascript:;" data-home="主页" title="主页"><i
                                class="fa fa-home" style="font-size: 1.08rem;"></i></a></li>
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" layuimini-content-href="SecuritySetting" data-title="安全设置">安全设置</a>
                        </dd>
